                  ...
                  child: CustomScrollView(
                    ...
                    slivers: [
                      if (_isTopActivity)
                        SliverToBoxAdapter(
                          child: Padding(
                            padding: adaptiveInset(top: 8, bottom: 8),
                            child: const Center(
                      ...
                      SliverGrid.builder(
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          crossAxisCount: 2,
                          mainAxisSpacing: adaptiveWidth(2),
                          crossAxisSpacing: adaptiveWidth(2),
                        ),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return NewsFeedItemDateSeparator(
